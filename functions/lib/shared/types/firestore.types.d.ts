...
export type SessionType = 'deep_work' | 'study' | 'creative' | 'reading' | 'exercise' | 'meditation' | 'coding' | 'writing' | 'custom';
...
export type GoalType = 'app_limit' | 'focus_target' | 'social_free_days' | 'weekly_focus_hours' | 'monthly_score' | 'custom';
...
export type HabitCategory = 'digital_wellness' | 'productivity' | 'health' | 'mindfulness' | 'sleep' | 'social' | 'custom';
...
export type NotificationType = 'blocking_alert' | 'goal_warning' | 'goal_achieved' | 'streak_alert' | 'achievement' | 'partner_activity' | 'challenge_update' | 'weekly_report' | 'ai_insight' | 'bedtime' | 'system' | 'referral';
...
export type ChallengeType = 'social_media_detox' | 'focus_marathon' | 'morning_person' | 'screen_time_slash' | 'deep_work' | 'custom';
