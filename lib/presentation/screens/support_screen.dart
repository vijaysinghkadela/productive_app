  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        _section('Quick Help', [
          _faq('How does app blocking work?',
          ...
          _faq('How is my productivity score calculated?',
          ...
          _faq('Can I use FocusGuard offline?',
          ...
          _faq('How do I cancel my subscription?',
        ...
        _section('Contact', [
          _contactOption('📧', 'Email Support', 'support@focusguard.app',
              AppColors.primary),
          _contactOption(
              '💬', 'Live Chat', 'Available for Elite users', AppColors.accent),
          _contactOption(
              '🐛', 'Report a Bug', 'Help us improve', AppColors.alert),
          _contactOption('💡', 'Feature Request', 'Tell us what you want',
              AppColors.success),
        ]),
        const SizedBox(height: 20),
        _section('Community', [
          _contactOption('💬', 'Discord Community', 'Join 5,000+ members',
              AppColors.primary),
          _contactOption('🐦', 'Twitter', '@FocusGuardApp', AppColors.accent),
        ]),
      ]),
    );
  }
