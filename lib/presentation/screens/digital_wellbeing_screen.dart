                    ...
                    itemBuilder: (context, i) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Center(
                            child: Text(_breathingModes[i].name,
                                style: TextStyle(
                                  fontSize: 12,
...
class _GaugePainter extends CustomPainter {
  final double value; // 0.0 to 1.0 (0=full budget remaining, 1=empty)
