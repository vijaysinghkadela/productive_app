      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        GradientText('Pro Plan',
                            style: const TextStyle(
                                fontSize: 16, fontWeight: FontWeight.w700)),
                        Text('Active · Renews Mar 15',
            ...
            // General section
            _SectionHeader(label: 'General', icon: Icons.tune_rounded),
            ...
            // Focus section
            _SectionHeader(label: 'Focus', icon: Icons.gps_fixed_rounded),
            const SizedBox(height: 10),
            _SettingsGroup(children: [
              _NavRow(
            ...
            // Data section
            _SectionHeader(label: 'Data & Privacy', icon: Icons.shield_rounded),
            const SizedBox(height: 10),
            _SettingsGroup(children: [
              _NavRow(
    ...
    return GlassCard(
      ...
      child: Column(
        children: List.generate(children.length * 2 - 1, (i) {
          if (i.isOdd) return Divider(color: AppColors.cardBorder, height: 1);
          return children[i ~/ 2];
        }),
      ),
    );
