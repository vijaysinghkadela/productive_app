              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('12,483 people active right now',
                        style: TextStyle(
            ...
            SliverList.builder(
              ...
              itemBuilder: (context, i) => Padding(
                padding: EdgeInsets.fromLTRB(
                    20, 0, 20, i < _challenges.length - 1 ? 10 : 0),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    _InfoPill(
                        icon: Icons.timer_outlined, label: challenge.duration),
                    const SizedBox(width: 8),
                    Container(
                      padding: const EdgeInsets.symmetric(
...
class _ChallengeData {
  final String name, description, participants, duration, difficulty;
  final Color color;
  final bool joined;
