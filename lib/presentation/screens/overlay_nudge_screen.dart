            ...
            child: IgnorePointer(
              child: Container(
                decoration: BoxDecoration(
                  border: Border.all(
                      color: AppColors.alert.withValues(alpha: 0.08), width: 4),
              ...
              builder: (context, value, child) {
                return Opacity(opacity: 0.3 + value * 0.7, child: child);
              }),
                ...
                children: [
                  ...
                  GradientText(
                    ...
                    gradient: const LinearGradient(
                      ...
                      builder: (context, value, child) {
                        return Opacity(
                            opacity: 0.7 + value * 0.3, child: child);
                      }),

                  Text('Your limit was $dailyLimit minutes',
                      style: TextStyle(
