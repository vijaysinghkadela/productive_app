    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          child:
            ...
            Row(children: [
              _binauralCard(
                  'Alpha', '8-13 Hz', 'Relaxed Focus', AppColors.success),
              const SizedBox(width: 10),
              _binauralCard(
                  'Beta', '14-30 Hz', 'Active Focus', AppColors.primary),
              const SizedBox(width: 10),
              _binauralCard(
                  'Theta', '4-7 Hz', 'Deep Meditation', AppColors.accent),
          ...
          Row(children: [
            ...
            GestureDetector(
                ...
                child: Container(
                    ...
                    child: Text('Stop All',
                        style:
                            TextStyle(color: AppColors.alert, fontSize: 12)))),
          ]),
          const SizedBox(height: 10),
          ..._playing.map((name) => Padding(
