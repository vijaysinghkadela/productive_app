                  ...
                  child: Row(
                    children: [
                      ...
                      CustomToggle(
                        ...
                        onChanged: (v) => setState(() => _focusModeActive = v),
                      ),
                    ],
                  ),
                ),
              ...
              itemBuilder: (context, i) {
                ...
                return Padding(
                  padding: EdgeInsets.fromLTRB(
                      20, 0, 20, i < socialMediaApps.length - 1 ? 8 : 0),
                  child: _AppBlockRow(
                    name: app,
                    isBlocked: isBlocked,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Requires biometric to unblock',
                                style: Theme.of(context).textTheme.bodySmall),
                          ],
                        ),
                      ),
...
class _AppBlockRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GlassCard(
      ...
      borderRadius: 14,
      borderColor: isBlocked ? AppColors.primary.withValues(alpha: 0.3) : null,
      child: Row(
        children: [
          Container(
            width: 40,
